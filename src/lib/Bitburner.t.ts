declare module "Bitburner" {
    ...
    export interface CodingContract {
         ...
         */
        attempt(answer: string[] | number, filename: string, host?: string,
                opts?: CodingAttemptOptions): boolean | string;
    ...
    export interface Sleeve {
         ...
         */
        setToFactionWork(sleeveNumber: number, factionName: string,
                         factionWorkType: string): boolean | undefined;
    ...
    interface HacknetServersFormulas {
         ...
         */
        hashGainRate(level: number, ramUsed: number, maxRam: number, cores: number,
                     mult?: number): number;
    ...
    interface Stanek {
         ...
         */
        canPlaceFragment(rootX: number, rootY: number, rotation: number,
                         fragmentId: number): boolean;
    ...
    export interface NS {
        ...
        exec(script: string, host: string, numThreads?: number,
             ...args: Array<string | number | boolean>): number;
         ...
         */
        getRunningScript(filename?: FilenameOrPID, hostname?: string,
                         ...args: (string | number)[]): RunningScript | null;
    ...
    export interface OfficeAPI {
         ...
         */
        assignJob(divisionName: string, cityName: string, employeeName: string,
         ...
         */
        throwParty(divisionName: string, cityName: string,
                   costPerEmployee: number): Promise<number>;
         ...
         * @returns A promise that is fulfilled when the assignment is complete.
         */
        setAutoJobAssignment(divisionName: string, cityName: string, job: string,
    ...
    export interface WarehouseAPI {
         ...
         */
        sellMaterial(divisionName: string, cityName: string, materialName: string, amt: string,
                     price: string): void;
         ...
         */
        setSmartSupplyUseLeftovers(divisionName: string, cityName: string, materialName: string,
         ...
         */
        buyMaterial(divisionName: string, cityName: string, materialName: string,
                    amt: number): void;
         ...
         * @param amt - Amount of material to buy
         */
        bulkPurchase(divisionName: string, cityName: string, materialName: string,
                     amt: number): void;
         ...
         */
        setMaterialMarketTA1(divisionName: string, cityName: string, materialName: string,
                             on: boolean): void;
         ...
         * @param on - market ta enabled
         */
        setMaterialMarketTA2(divisionName: string, cityName: string, materialName: string,
                             on: boolean): void;
         ...
         */
        limitMaterialProduction(divisionName: string, cityName: string, materialName: string,
                                qty: number): void;
         ...
         * @param qty - Amount to limit to
         */
        limitProductProduction(divisionName: string, cityName: string, productName: string,
                               qty: number): void;
