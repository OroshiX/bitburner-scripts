...
WebServer.prototype.start = function () {
    ...
    httpServer.createServer(function (req, res) {
        ...
        let requestedFile = path.join(self.config.directory, request);
        ...
        fs.readFile(requestedFile, "binary", function (err, file) {
            if (err) {
                ...
                const contentType            = self.contentTypes[path.extname(requestedFile)];
...
if (require.main === module) {
    ...
    let i, length, fileInfo, configuration = {};
